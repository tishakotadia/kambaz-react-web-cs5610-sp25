    ...
    return (
      <div>
        ...
        <ul id="wd-modules">
          ...
          <li className="wd-module">
            <div className="wd-title">Week 3, Lecture 3 - Formatting User Interfaces with CSS</div>
            <ul className="wd-lessons">
              <li className="wd-lesson">
                <span className="wd-title">LEARNING OBJECTIVES</span>
                <ul className="wd-content">
              ...
              <li className="wd-lesson">
                <span className="wd-title">SLIDES</span>
                <ul className="wd-content">
                  <li className="wd-content-item">Introduction to CSS and Flex</li>
                  <li className="wd-content-item">Formatting Web content with CSS styling</li>
                </ul>
              </li>
            </ul>
          </li>
