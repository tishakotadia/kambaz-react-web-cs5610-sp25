...
tag to tell browsers to render the gaps.
  ...
  My favorite recipe: Onion Rice
  <ol id="wd-your-favorite-recipe">
  <li>Chop the onions.</li>
    <li>Fry them in a pan with light oil.</li>
    <li>Add rice and mix well.</li>
    <li>Add spices as per your need.</li>
    <li>Add some ghee so that it tastes well.</li>
  </ol>
...
<a href="https://github.com/tishakotadia" id="wd-github"> click here </a>
